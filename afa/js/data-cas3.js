...
(function () {
  ...
  add('m1', [
    ...
    { id: 'm1g06', chap: 'c1', type: 'single',
      ...
      q: "Quelle caractéristique du risque cela illustre-t-il ?",
      choices: ["Un risque de masse sans particularité", "Un risque de cumul, qui met en échec la compensation dans l'espace", "Un risque spéculatif", "Un risque subjectif"],
      answer: [1],
      explain: "Un même événement frappe tout le portefeuille au même moment : c'est pourquoi ces risques exigent réassurance et pools." },
    ...
    { id: 'm1g14', chap: 'c3', type: 'single',
      ...
      q: "De quel pilier s'agit-il ?", choices: PILIERS, answer: [2],
      explain: "C'est le pilier 3a, dit lié : déductible fiscalement, réservé aux personnes exerçant une activité lucrative, avec des cas de retrait limitativement énumérés." },
    ...
    { id: 'm1g18', chap: 'c3', type: 'single',
      ...
      choices: ["En janvier 2025", "En décembre 2026, avec la rente de décembre", "En janvier 2027", "Le supplément n'existe pas encore"],
      answer: [1],
      explain: "La 13e rente AVS équivaut à un douzième de la rente annuelle et est versée automatiquement avec la rente de décembre, pour la première fois en décembre 2026." },

    /* --- Branches : dommages ou sommes --- */
    { id: 'm1g19', chap: 'c4', type: 'single',
      ...
      q: "De quelle nature est cette assurance ?", choices: NATURE, answer: [1],
      explain: "La prestation est fixée d'avance, sans lien avec le dommage : c'est une assurance de sommes, cumulable et sans subrogation." },

    { id: 'm1g20', chap: 'c4', type: 'single',
      ...
      q: "De quelle nature est cette assurance ?", choices: NATURE, answer: [0],
      explain: "La prestation suit le dommage effectivement subi : principe indemnitaire, sous-assurance possible et subrogation contre un éventuel responsable." },
