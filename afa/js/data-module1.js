...
(function () {
  ...
  M.questions = [
    ...
    { id: 'm1c2q2', chap: 'c2', type: 'single', pts: 1, cx: 'Simple',
      theme: "IA, principes techniques, loi des grands nombres",
      q: "Qu'énonce la loi des grands nombres ?",
      choices: [
        "Plus les cas observés sont nombreux, plus le résultat réel approche la probabilité théorique",
        "Plus le risque assuré est important, plus la prime augmente proportionnellement",
        "Plus l'assureur est grand, plus les primes qu'il pratique sont basses",
        "Plus le portefeuille grandit, plus le nombre de sinistres par contrat augmente",
      ],
      answer: [0],
      explain: "C'est le fondement statistique de l'assurance : ce qui est imprévisible pour un individu devient calculable sur une collectivité. Encore faut-il que les risques soient homogènes et indépendants." },
    ...
    { id: 'm1c2q7', chap: 'c2', type: 'single', pts: 1, cx: 'Simple',
      theme: "IA, principes techniques, antisélection",
      q: "Qu'entend-on par « antisélection » dans un portefeuille d'assurance ?",
      choices: [
        "Les bons risques s'en vont, les mauvais restent et la sinistralité se dégrade",
        "L'assureur refuse les risques qui ne correspondent pas à son appétit",
        "Le réassureur choisit les risques qu'il accepte de reprendre",
        "L'assureur retient les sinistres qu'il indemnise en priorité",
      ],
      answer: [0],
      explain: "Un tarif trop grossier fait payer aux bons risques une prime supérieure à leur coût réel : ils partent chez un concurrent mieux tarifé. Le portefeuille se concentre sur les mauvais risques et la sinistralité monte — d'où l'importance de classes de risque homogènes." },
    ...
    { id: 'm1c3q4', chap: 'c3', type: 'single', pts: 1, cx: 'Simple',
      theme: "IA, trois piliers, rente AVS",
      q: "À combien s'élève, en 2026, la rente AVS mensuelle maximale d'une personne seule ?",
      choices: [
        "CHF 1 260.–",
        "CHF 2 450.–",
        "CHF 2 520.–",
      ...
      answer: [2],
      explain: "La rente maximale vaut exactement le double de la rente minimale de CHF 1 260.–. Le montant de CHF 3 780.– est le plafond applicable à un couple, soit 150 % de la rente maximale individuelle." },
    ...
    /* --- c4 : branches --- */
    { id: 'm1c4q1', chap: 'c4', type: 'single', pts: 1, cx: 'Simple',
      theme: "IA, classification, dommage-somme",
      q: "Qu'est-ce qui distingue essentiellement l'assurance de dommages de l'assurance de sommes ?",
      choices: [
        "Le mode de calcul de la prestation : dommage effectif ou capital convenu",
        "Le montant de la prime, plus élevé en assurance de sommes",
        "Le caractère obligatoire, propre à l'assurance de sommes",
        "La clientèle visée, les entreprises pour l'assurance de dommages",
      ],
      answer: [0],
      explain: "L'assurance de dommages répare un préjudice constaté et ne peut pas enrichir l'assuré ; l'assurance de sommes verse le montant convenu d'avance. De là découle tout le reste : subrogation et interdiction du cumul d'un côté, cumul libre de l'autre." },
    ...
    { id: 'm1c4q4', chap: 'c4', type: 'single', pts: 1, cx: 'Simple',
      theme: "IA, classification, assurance-vie",
      q: "Comment se qualifie une assurance-vie versant un capital décès convenu ?",
      choices: [
        "Comme une assurance de dommages",
        "Comme une assurance de choses",
        "Comme une assurance de sommes",
        "Comme une assurance sociale",
      ],
      answer: [2],
      explain: "Le capital est fixé au contrat et versé tel quel : aucun dommage n'est évalué, la vie humaine n'ayant pas de valeur patrimoniale chiffrable. C'est pourquoi il se cumule librement avec toute autre prestation." },

    { id: 'm1c4q5', chap: 'c4', type: 'single', pts: 1, cx: 'Simple',
      theme: "IA, marché suisse, monopoles cantonaux",
      q: "Comment l'assurance incendie du bâtiment est-elle organisée dans la majorité des cantons suisses ?",
      choices: [
        "Elle est libre auprès de n'importe quel assureur privé",
        "Elle est confiée à un établissement cantonal en situation de monopole",
        "Elle est gérée directement par la Confédération",
        "Elle est facultative et laissée à l'appréciation du propriétaire",
      ],
      answer: [1],
      explain: "Dix-neuf cantons connaissent un établissement cantonal d'assurance des bâtiments, avec affiliation obligatoire et prime souvent plus basse. Les cantons dits « GUSTAVO » laissent en revanche jouer le marché privé." },
