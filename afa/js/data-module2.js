...
(function () {
  ...
  M.questions = [
    ...
    { id: 'm2c1q3', chap: 'c1', type: 'single',
      q: "La capacité d'exercice suppose :",
      choices: ["La majorité uniquement", "La capacité de discernement uniquement", "La majorité et la capacité de discernement", "L'inscription au registre du commerce"],
      answer: [2],
      explain: "Il faut être majeur (18 ans) ET capable de discernement pour s'obliger valablement par ses propres actes." },

    { id: 'm2c1q4', chap: 'c1', type: 'single',
      q: "Un contrat conclu par une personne totalement incapable de discernement est :",
      choices: ["Valable", "Nul", "Boiteux, en suspens jusqu'à ratification", "Annulable dans un délai d'un an"],
      answer: [1],
      explain: "L'absence de discernement entraîne la nullité absolue de l'acte. Le contrat « boiteux » concerne le mineur capable de discernement qui agit sans le consentement de son représentant légal." },
    ...
    /* --- c2 --- */
    { id: 'm2c2q1', chap: 'c2', type: 'single',
      q: "Comment un contrat se forme-t-il selon l'art. 1 CO ?",
      choices: ["Par la signature d'un document écrit", "Par l'échange de manifestations de volonté réciproques et concordantes", "Par le paiement d'une prime", "Par l'inscription dans un registre"],
      answer: [1],
      explain: "Offre + acceptation. La forme écrite n'est nécessaire que si la loi ou les parties l'exigent : la liberté de la forme est la règle (art. 11 CO)." },

    { id: 'm2c2q2', chap: 'c2', type: 'single',
      q: "Le silence de celui qui reçoit une offre :",
      choices: ["Vaut acceptation dans tous les cas", "Ne vaut en principe pas acceptation", "Vaut refus définitif et irrévocable", "Prolonge automatiquement le délai"],
      answer: [1],
      explain: "Qui ne dit mot ne consent pas, en droit suisse. Il n'y a d'exception qu'en présence d'un usage particulier ou d'une relation d'affaires durable." },
    ...
    { id: 'm2c3q6', chap: 'c3', type: 'single',
      ...
      choices: ["Tous les faits imaginables concernant sa vie privée", "Uniquement les faits importants sur lesquels l'assureur a posé des questions précises et non équivoques", "Uniquement ce qu'il juge utile", "Rien, l'assureur doit se renseigner lui-même"],
      answer: [1],
      explain: "Le questionnaire délimite l'obligation de déclarer : sont importants les faits sur lesquels l'assureur a posé des questions écrites, précises et non équivoques (art. 4 LCA)." },

    { id: 'm2c3q7', chap: 'c3', type: 'single',
      q: "Dans quel délai l'assureur doit-il résilier le contrat en cas de réticence ?",
      choices: ["14 jours dès la conclusion", "4 semaines dès qu'il a eu connaissance de la réticence", "6 mois dès le sinistre", "5 ans dès la conclusion"],
      answer: [1],
      explain: "4 semaines dès la connaissance de la réticence (art. 6 LCA). Le droit de résiliation s'éteint en tout état de cause 5 ans après la conclusion du contrat." },

    { id: 'm2c3q8', chap: 'c3', type: 'single',
      q: "En cas de réticence, à quelle condition l'assureur peut-il refuser sa prestation pour un sinistre déjà survenu ?",
      choices: ["Sans condition, dès qu'il y a réticence", "Uniquement si le fait tu a influé sur la survenance ou l'étendue du sinistre", "Uniquement si le sinistre dépasse CHF 10 000.–", "Uniquement en assurance-vie"],
      answer: [1],
      explain: "C'est l'apport majeur de la révision : il faut un lien de causalité entre le fait non déclaré et le sinistre. Sans causalité, l'assureur peut résilier pour l'avenir mais doit payer." },
