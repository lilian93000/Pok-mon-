...
(function () {
  ...
  M.questions = [
    ...
    { id: 'm2c4q3', chap: 'c4', type: 'single', pts: 2, cx: 'Moyenne',
      theme: "Droit, LCA, inaction de l'assureur",
      q: "Que se passe-t-il si l'assureur ne poursuit pas le paiement dans les deux mois suivant l'expiration du délai de sommation ?",
      choices: [
        "Le contrat se poursuit normalement, la prime restant due",
        "L'assureur est censé s'être départi du contrat",
        "La couverture est rétablie automatiquement et rétroactivement",
        "L'assureur doit rembourser l'ensemble des primes encaissées",
      ],
      answer: [1],
      explain: "Le contrat s'éteint et l'assureur perd sa créance de prime arriérée. Il ne récupère pas non plus les primes déjà encaissées pour la période où il a réellement porté le risque." },

    { id: 'm2c4q4', chap: 'c4', type: 'single', pts: 2, cx: 'Moyenne',
      theme: "Droit, LCA, résiliation ordinaire",
      q: "Un contrat conclu le 1er janvier 2024 pour une durée de dix ans doit être résilié par le preneur à la première occasion. Pour quelle date, et avec quel préavis ?",
      choices: [
        "Pour le 31 décembre 2024, avec un préavis d'un mois",
        "Pour le 31 décembre 2026, avec un préavis de trois mois",
        "Pour le 31 décembre 2033, à l'échéance du contrat",
        "À tout moment, sans préavis à respecter",
      ],
      answer: [1],
      explain: "La troisième année s'achève le 31 décembre 2026 : c'est la première échéance utilisable, moyennant un congé notifié trois mois avant, donc d'ici fin septembre 2026. Ensuite, l'occasion se représente chaque année." },

    { id: 'm2c4q5', chap: 'c4', type: 'single', pts: 2, cx: 'Moyenne',
      theme: "Droit, LCA, résiliation après sinistre",
      q: "Une prestation a été versée à la suite d'un sinistre partiel. Qui peut résilier le contrat ?",
      choices: [
        "Le preneur d'assurance seulement",
        "L'entreprise d'assurance seulement",
        "Les deux parties, l'assureur ne le pouvant pas en maladie complémentaire",
        "Aucune des deux, le contrat se poursuivant jusqu'à l'échéance",
      ],
      answer: [2],
      explain: "Art. 42 LCA : le droit est réciproque après le versement d'une prestation. Il est toutefois retiré à l'assureur en assurance-maladie complémentaire, pour éviter qu'il ne se débarrasse des assurés devenus coûteux." },
    ...
    { id: 'm2c4q7', chap: 'c4', type: 'single', pts: 1, cx: 'Simple',
      theme: "Droit, LCA, diminution du risque",
      q: "Le preneur constate une diminution essentielle du risque. Que peut-il exiger ?",
      choices: [
        "La résiliation immédiate assortie de dommages-intérêts",
        "Une réduction de la prime",
        "Le remboursement de l'ensemble des primes déjà versées",
        "Rien : seule l'aggravation produit des effets",
      ],
      answer: [1],
      explain: "La symétrie est logique : si le risque baisse, le prix doit suivre. La réduction vaut pour l'avenir, à compter de l'annonce faite à l'assureur." },
