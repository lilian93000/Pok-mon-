  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <div
        ...
        className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-brand/20 p-8 text-center transition-colors hover:border-brand/40 hover:bg-brand-soft/30"
      >
        {logo ? (
          ...
          <>
            ...
            <p className="mt-1 text-sm text-slate">PNG ou SVG · fond transparent conseillé</p>
          </>
        )}
        <input
          ref={inputRef}
      ...
      <div className="rounded-2xl border border-brand/10 bg-white p-5 shadow-card">
        ...
        <div className="flex items-center justify-between border-b border-brand/10 pb-3">
          ...
          {logo ? (
            ...
            <span className="flex items-center gap-1.5 text-sm font-semibold text-slate">
